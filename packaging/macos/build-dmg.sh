#!/usr/bin/env bash
# Build a universal2 (arm64 + x86_64) macOS .dmg for Nostalgia Launcher.
#
# Must run on macOS with a *universal* Python/PySide6 environment, e.g.:
#   uv sync --dev
#   ./packaging/macos/build-dmg.sh
#
# Produces: dist/NostalgiaLauncher-universal2.dmg
#
...
rm -f "$DMG"
hdiutil create -volname "Nostalgia Launcher" \
