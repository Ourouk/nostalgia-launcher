...
from ui_state import ModPending, ModsState, ModState
...
class ModsController:
    ...
    def maybe_install_essential_mods(self) -> bool:
        ...
        # "Install essential mods" (Settings → General) gates the full
        # essential set. VanillaFixes is exempt — it's the loader the other
