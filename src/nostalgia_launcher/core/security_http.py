...
``secure_urlopen`` is retained as a compatibility shim that delegates to
:mod:`httpx` so existing callers and test monkeypatches keep working
while new code should prefer :func:`make_secure_client`.
