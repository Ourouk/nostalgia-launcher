"""Nostalgia Launcher Qt (PySide6) application context and shell.

Owns the process-wide QApplication singleton (`create_qt_app`) and the
`QtNostalgiaLauncherApp` shell that the entry point imports for
`NOSTALGIA_UI_BACKEND=qt`. The window chrome (header, tabs, footer) lives in
