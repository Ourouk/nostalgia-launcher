"""Tests for GUI backend selection in octo_updater.cli.
...
def test_main_returns_1_when_qt_import_fails(monkeypatch, capsys):
    ...
    monkeypatch.setitem(sys.modules, "octo_updater.ui.qt.app", None)
    assert cli.main() == 1
