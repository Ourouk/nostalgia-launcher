...
a full QtNostalgiaLauncherApp builds and runs. They verify:
...
from nostalgia_launcher.ui.qt.metrics import BASE_H, BASE_W, clamp
...
def build_app(qapp, monkeypatch, qt_env):
    """Factory for full QtNostalgiaLauncherApp instances with safe backends (same
